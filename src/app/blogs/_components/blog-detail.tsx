    ...
    return (
        <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-12">
                    ...
                    <div className="flex items-center gap-4 p-4 bg-white dark:bg-neo-dark-gray border-[3px] border-black dark:border-neo-cream shadow-neo">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-700 dark:text-gray-300 font-medium mt-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis accusamus nisi ad minus dignissimos.</p>
                        </div>
                    </div>
                </div>
            </ScrollReveal>
            ...
            <ScrollReveal width="100%" delay={0.2}>
               <div
                className=' prose-lg max-w-none w-full prose-headings:font-title font-default prose mt-4 dark:prose-invert focus:outline-none prose-a:text-neo-pink hover:prose-a:text-neo-purple prose-img:border-[3px] prose-img:border-black dark:prose-img:border-neo-cream prose-img:shadow-neo text-neo-black dark:text-neo-cream font-medium leading-relaxed'
