...
export const About: React.FC = () => {
  ...
  return (
    <section id="about" className="py-20 px-4 md:px-8 bg-white dark:bg-neo-black border-y-4 border-neo-black dark:border-neo-cream relative transition-colors duration-300">
          ...
          <div className="w-full md:w-1/2">
             <ScrollReveal direction="right">
               <div className="relative">
                 <BrutalistCard color="bg-neo-yellow" className="transform rotate-2 z-10 relative">
                   <h2 className="text-4xl md:text-5xl font-display font-black mb-6 text-neo-black">WHO AM I?</h2>
                   <p className="text-xl font-bold leading-relaxed mb-4 text-neo-black">
                   ...
                   <p className="text-lg mb-6 border-l-4 border-neo-black pl-4 italic text-neo-black">
              ...
              <ScrollReveal key={index} delay={index * 0.1} width="100%">
                <div className="group">
                  <div className={`
                    ...
                    shadow-neo transition-all group-hover:-translate-y-2 group-hover:shadow-neo-lg
                    ${index % 2 === 0 ? '-rotate-2' : 'rotate-2'}
                  `}>
                    <div className="text-neo-pink group-hover:scale-110 transition-transform">{stat.icon}</div>
                    <h3 className="font-display font-bold text-lg text-neo-black dark:text-neo-cream">{stat.label}</h3>
